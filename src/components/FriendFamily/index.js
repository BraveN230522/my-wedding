        ...
        <div className='row'>
          <div className='col-12 text-center mb-2'>
            <ul className='list-inline mb-4' id='portfolio-flters'>
              <li className='btn btn-outline-primary font-weight-bold m-1 py-2 px-4' data-filter='.first'>
                Groomsmen
              </li>
              <li className='btn btn-outline-primary font-weight-bold m-1 py-2 px-4' data-filter='.second'>
                Bridesmaid
              </li>
            </ul>
          </div>
